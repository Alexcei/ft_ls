...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/15 19:40:40 by bpole             #+#    #+#             */
/*   Updated: 2019/11/15 20:20:27 by bpole            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			ft_get_data2(char *d_name, t_data *data,
					t_avltree1 **root, t_width *width)
{
	char			*tmp;
	char			*res;
	t_data			*data_subtree;
	...
	{
		data_subtree = ft_get_data(res, data->flag, data->level + 1, width);
		if (data_subtree)
		{
